		...
		<div class="row">
			...
			<div class="col-md-5 col-md-push-2">
				<div id="product-main-img">
					...
					@if($image->image_id == $product->id)
					<div class="product-preview">
						<img src="{{asset('img/'.$image->url)}}" alt="">
					</div>
					@endif
					@endforeach
				</div>
			...
			<div class="col-md-5">
				<div class="product-details">
					...
					<div>
						...
						<a class="review-link" href="#">10 Отзывов | Добавите ваш отзыв</a>
					</div>
					<div>
						<h3 class="product-price">{{$product->price}} <del
								class="product-old-price">{{$product->old_price}}</del></h3>
					...
					<ul class="product-btns">
						<li><a href="#"><i class="fa fa-heart-o"></i> Добавить в вишлист</a></li>
						<li><a href="#"><i class="fa fa-exchange"></i> Сравнить</a></li>
					</ul>

					<ul class="product-links">
						<li>Category:</li>
						<li><a href="#">Компьютерные наушники</a></li>
										...
										<ul class="reviews">
											<li>
												<div class="review-heading">
													<h5 class="name">Бахадыр</h5>
													<p class="date">27 ДЕК 2018, 8:0 PM</p>
